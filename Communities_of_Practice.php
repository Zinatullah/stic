...
<section class="Feautes section">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title" style="padding: 0px !important; height: 50vh" >
					<h2 style="font-family: Garamond; text-align: <?php echo $lng !="en" ? 'right' : 'left' ?>; font-size:18pt; margin: 0;font-weight: bolder; direction: <?php echo $lng !="en" ? 'rtl' : 'ltr' ?>">
						<?php echo $CommunitiesـofـPractice_head ?>
					</h2>
					<p style="text-align: justify; font-size: 12pt; color: black; font-family: 'Times New Roman'; margin-top: 5px; direction: <?php echo $lng !="en" ? 'rtl' : 'ltr' ?>">
						<?php echo $CommunitiesـofـPractice_paragraph ?>
					</p>
				</div>
			</div>
		</div>
