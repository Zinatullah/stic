...
<head>
    ...
    <meta property="og:description" content="Exploring Innovative Opportunities">
    <meta property="og:url" content="https://stic.aogc.dev">
    <meta property="og:image" itemprop="image" content="https://stic.aogc.dev/logo/stic_logo.png">
    <meta property="og:type" content="website">
    <meta property="og:image:type" content="image/png">
    <meta property="og:updated_time" content="1619600299" />

    <link rel="shortcut icon" href="https://stic.aogc.dev/logo/stic_logo.png" type="image/png">
    ...
    <header class="header">
        <div class="text-center p-2" style="background: #87CEEB;border-radius: 30px;margin: 5px;padding: 5px;">
            <h4 class="text-cetner" style="color: black; font-family: garamond; font-weight: 900;">
                Science,Technology, and Innovation (STI) Commission Afghanistan
            </h4>
        </div>
        ...
        <div class="header-inner">
            <div class="container-fluid">
                <div class="inner">
                    <div class="row">
                        <div class="col-12" style="direction: <?php echo $lng != "en" ? 'rtl' : 'ltr' ?>; ">
                            <div class="mobile-nav"></div>
                            <div class="main-menu">
                                <nav class="navigation">
                                    <ul class="nav menu" style="margin-top: 10px">
                                        <li style="margin: 0px; position:absolute; top: -20px; cursor: pointer">
                                            <img src="./logo/logo.svg" alt="" width="150px">
                                        </li>
                                        <br />
                                        <li style="margin-left: 150px !important; margin: 0px;"><a href="/sti"><?php echo $home; ?></a></li>
