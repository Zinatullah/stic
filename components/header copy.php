...
<body>
    ...
    <!-- Header Area -->
    <header class="header">
        <div class="text-center p-2" style="background: lightblue;;border-radius: 30px;margin: 5px;padding: 5px;">
            <h4 class="text-cetner" style="color: black;">
                        ...
                        <div class="col-12" style="direction: <?php echo $lng != "en" ? 'rtl' : 'ltr' ?>; ">
                            ...
                            <div class="main-menu">
                                <nav class="navigation">
                                    <ul class="nav menu">
                                        <li style="margin: 0px;"><a href="index.php"><?php echo $home; ?></a></li>
                                        ...
                                        <li style="display: <?php echo $display ?>;">
                                            <a href="#">
                                                <span style="position:relative; top: -8px; right: 10px; color: black; cursor: pointer">
                                                    <?php echo $result[1] ?>
                                                </span>
